...
const statusStyles = {
  ...
  requested:    'bg-teal-100 text-teal-800 dark:bg-teal-900/40 dark:text-teal-300 animate-pulse',
...
const priorityStyles = {
  ...
  emergency: 'bg-red-100 text-red-800 dark:bg-red-900/40 dark:text-red-300 animate-pulse',
}
</script>
